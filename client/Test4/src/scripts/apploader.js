...
class ConchRenderObject {
    constructor() {
        this._nativeObj = new _conchRenderObject();
        this.id = this._nativeObj.conchID;
    }
    drawSubmesh(submesh, drawType, renderMode, offset, count) {
        var _ = conch.bf;
        _.needsz(28);
        _.wu32(this.id);
        _.wu32(0);
        _.wu32(submesh ? submesh.id : -1);
        _.wu32(drawType);
        _.wu32(renderMode);
        _.wu32(offset);
        _.wu32(count);
    ...
    boundingBox(boxMin, boxMax) {
        ...
        _.wu32(this.id);
        _.wu32(1);
        _.wab(boxMin, boxMin.byteLength);
        _.wab(boxMax, boxMax.byteLength);
    }
    matrix(matrix) {
        var _ = conch.bf;
        _.needsz(8);
        _.wu32(this.id);
        _.wu32(2);
        _.wab(matrix, matrix.byteLength);
    }
    visible(b) {
        _Buffer.oneInt(this, 3, b ? 1 : 0);
    }
    flag(n) {
        _Buffer.oneInt(this, 4, n);
    }
}
window["ConchRenderObject"] = ConchRenderObject;
class ConchVertexDeclare {
    constructor(n) {
        this._nativeObj = new _conchVertexDeclare(n);
        this.id = this._nativeObj.conchID;
    }
    setDelcare(decls) {
        var _ = conch.bf;
        ...
        decls.forEach((v, i, a) => {
            _.needsz(12);
            _.wu32(v.offset);
            _.wu32(v.elementFormat);
            _.wu32(v.elementUsage);
        });
    }
    addShaderDefine(id) {
        var _ = conch.bf;
...
window["ConchVertexDeclare"] = ConchVertexDeclare;
class ConchMesh {
    constructor() {
        this.submeshs = [];
    }
    addSubmesh(submesh) {
        this.submeshs.push(submesh);
    }
}
window["ConchMesh"] = ConchMesh;
class ConchSubmesh {
    constructor() {
        this._nativeObj = new _conchSubmesh();
        this.id = this._nativeObj.conchID;
    }
    setVertexBuffer(vd, buffer) {
        var _ = conch.bf;
        _.needsz(16);
        _.wu32(this.id);
        _.wu32(0);
        var declid = vd ? vd.id : -1;
        _.wu32(declid);
    ...
    setVBIB(decl, vb, ib) {
        ...
        _.wu32(this.id);
        _.wu32(3);
        _.wu32(decl ? decl.id : -1);
        _.wu32(vb.byteLength);
        _.wab(vb, vb.byteLength);
        if (ib) {
            _.needsz(8);
            _.wu32(1);
            _.wu32(ib.byteLength);
            _.wab(ib, ib.byteLength);
        }
        else {
            _.needsz(4);
            _.wu32(0);
    ...
    setShaderValue(nSemanticsEnum, ab, t) {
        var i = ab.byteLength;
        var _ = conch.bf;
        _.needsz(12);
        _.wu32(this.id);
        _.wu32(6);
        _.wu32(nSemanticsEnum);
        _Buffer.wany(_, ab, t);
    }
}
window["ConchSubmesh"] = ConchSubmesh;
class ConchShader {
    constructor() {
        this._nativeObj = new _conchShader();
        this.id = this._nativeObj.conchID;
    }
    setSrc(vs, ps) {
        var _ = conch.bf;
    ...
    setAttrDeclare(decls) {
        ...
        decls.forEach((v, i, a) => {
            _.needsz(8);
            _.wstring(v.name, true);
            _.wu32(v.elementUsage);
        });
    }
    setUniformDeclare(decls) {
        var _ = conch.bf;
        _.needsz(12);
        _.wu32(this.id);
        _.wu32(2);
...
window["ConchShader"] = ConchShader;
class ConchShaderValue {
    constructor() {
        this._nativeObj = new _conchShaderValue();
        this.id = this._nativeObj.conchID;
    }
    setDesc(descs) {
        var _ = conch.bf;
...
window["ConchShaderValue"] = ConchShaderValue;
class ConchMaterial {
    constructor() {
        this._nativeObj = new _conchMaterial();
        this.id = this._nativeObj.conchID;
    }
    setShader(shader) {
        var i = shader ? shader.id : -1;
        _Buffer.oneInt(this, 0, i);
    }
    setTexture(texture, id, semantics) {
        var textureID = texture ? texture.id : -1;
        this.tex = texture;
        var _ = conch.bf;
        _.needsz(20);
        _.wu32(this.id);
    ...
    setRenderMode(d) {
        _Buffer.oneInt(this, 5, d);
    }
}
window["ConchMaterial"] = ConchMaterial;
class ConchTexture {
    constructor() {
        this._nativeObj = new _conchTexture();
        this.id = this._nativeObj.conchID;
    }
    setTexture2DImage(img) {
        var imgId = img ? img.imgId : -1;
        this.image = img;
        var _ = conch.bf;
        _.needsz(12);
        _.wu32(this.id);
    ...
    setMinFifter(d) {
        _Buffer.oneInt(this, 4, d);
    }
    setMaxFifter(d) {
        _Buffer.oneInt(this, 5, d);
    }
    setWrapMode(s, t) {
        _Buffer.point(this, 6, s, t);
    }
}
window["ConchTexture"] = ConchTexture;
class ConchCamera {
    constructor() {
        this._nativeObj = new _conchCamera();
        this.id = this._nativeObj.conchID;
    }
    setViewMatrix(matrix) {
        ...
        _.wu32(this.id);
        _.wu32(0);
        _.wu32(matrix.byteLength);
        _.wab(matrix.buffer, matrix.byteLength, matrix.byteOffset);
    }
    ...
    setRenderTarget(renderTexture) {
        ...
        _.wu32(this.id);
        _.wu32(2);
        _.wu32(renderTexture ? renderTexture.id : -1);
    }
    setRenderType(type) {
        var _ = conch.bf;
        _.needsz(12);
    ...
    setSkyMesh(skyMesh) {
        ...
        _.wu32(this.id);
        _.wu32(4);
        _.wu32(skyMesh ? skyMesh.id : -1);
    }
    setProjectInfo(fov, width, height, near, far) {
        var _ = conch.bf;
        _.needsz(28);
        _.wu32(this.id);
        _.wu32(5);
    ...
    lookAt(eye, target, up) {
        ...
        _.wu32(this.id);
        _.wu32(6);
        _.wab(eye, eye.byteLength);
        _.wab(target, target.byteLength);
        _.wab(up, up.byteLength);
    }
}
window["ConchCamera"] = ConchCamera;
class ConchScene {
    constructor() {
        this._nativeObj = new _conchScene();
        this.id = this._nativeObj.conchID;
    }
    init(sizeX, sizeY, sizeZ, nDepth) {
        var _ = conch.bf;
        _.needsz(24);
        _.wu32(this.id);
        _.wu32(0);
    ...
    addChildAt(renderObj, i) {
        if (renderObj instanceof ConchCamera) {
            this.addCamera(renderObj);
            return;
        }
        var _ = conch.bf;
        _.needsz(12);
        _.wu32(this.id);
        _.wu32(1);
        _.wu32(renderObj ? renderObj.id : -1);
    }
    removeChild(renderObj) {
        if (renderObj instanceof ConchCamera) {
            this.removeCamera(renderObj);
            return;
        }
        var _ = conch.bf;
        _.needsz(12);
    ...
    setGlobalLightInfo(dir) {
        var _ = conch.bf;
        _.needsz(8);
        _.wu32(this.id);
        _.wu32(9);
        _.wab(dir, dir.byteLength);
    }
    setRootNode() {
    }
    setFPSNode() {
...
window["ConchScene"] = ConchScene;
class ConchSkyMesh {
    constructor() {
        this._nativeObj = new _conchSkyMesh();
        this.id = this._nativeObj.conchID;
    }
    setVBIB(decl, vb, ib) {
        var _ = conch.bf;
    ...
    setTexture(texture, id, nSemanticsEnum) {
        var textureID = texture ? texture.id : -1;
        var _ = conch.bf;
        _.needsz(20);
        _.wu32(this.id);
    ...
    setTextureCube(texture, id, nSemanticsEnum) {
        var textureID = texture ? texture.id : -1;
        var _ = conch.bf;
        _.needsz(20);
        _.wu32(this.id);
...
window["ConchSkyMesh"] = ConchSkyMesh;
...
class WebGLRenderingContext {
    ...
    bufferData(target, sizeOrArray, usage) {
        ...
        if (typeof (arguments[1]) === 'number') {
            ...
            conch.bf.wab(arguments[1].buffer, length);
        }
    }
    createShader(type) {
        var fadeID = this.createFadeID();
    ...
    texImage2D(target, level, internalformat, width, height, border, format, type, pixels) {
        if (arguments.length == 9) {
            ...
            conch.bf.wu32(this.id);
            conch.bf.wu32(26);
            conch.bf.wu16(arguments[0]);
            conch.bf.wu16(arguments[1]);
            conch.bf.wu16(arguments[2]);
            conch.bf.wu16(arguments[3]);
            conch.bf.wu16(arguments[4]);
            conch.bf.wu16(arguments[5]);
            conch.bf.wu16(arguments[6]);
            conch.bf.wu16(arguments[7]);
            var argobj = arguments[5] && arguments[8]._nativeObj;
            if (argobj) {
                conch.bf.needsz(8);
            ...
            conch.bf.wu16(arguments[2]);
            conch.bf.wu16(arguments[3]);
            conch.bf.wu32(arguments[4]);
            var argobj = arguments[5] && arguments[5]._nativeObj;
            if (argobj) {
                if (argobj && argobj.isCanvas && argobj.isCanvas()) {
                    alert("texSubImage2D:禁止2D和3D混合了 " + (new Error())['stack']);
                    conch.bf.wu32(1);
    ...
    texSubImage2D(target, level, xoffset, yoffset, format, type, source) {
        ...
        conch.bf.wu16(arguments[4]);
        conch.bf.wu16(arguments[5]);
        var argobj = arguments[6] && (arguments[6]._nativeObj || arguments[6]);
        if (argobj) {
            if (argobj && argobj.isCanvas && argobj.isCanvas()) {
                var e = new Error('dd');
    ...
    uniformxv(cmd, location, v) {
        ...
        conch.bf.wu32(length);
        conch.bf.wab(v.buffer || v, length);
    }
    _uniformMatrixfv_x(cmd, location, transpose, values, number) {
        ...
        conch.bf.wu32(length);
        conch.bf.wab(values.buffer || values, length);
    }
    ...
    bufferSubData(target, offset, data) {
        ...
        conch.bf.wu32(length);
        conch.bf.wab(data.buffer || data, length);
    }
